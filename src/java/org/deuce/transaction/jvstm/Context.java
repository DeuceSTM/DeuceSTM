...
import org.deuce.transaction.jvstm.field.BoolValue;
import org.deuce.transaction.jvstm.field.ByteValue;
import org.deuce.transaction.jvstm.field.CharValue;
import org.deuce.transaction.jvstm.field.DoubleValue;
import org.deuce.transaction.jvstm.field.FloatValue;
import org.deuce.transaction.jvstm.field.IntValue;
import org.deuce.transaction.jvstm.field.LongValue;
import org.deuce.transaction.jvstm.field.ObjectValue;
import org.deuce.transaction.jvstm.field.ShortValue;
import org.deuce.transaction.jvstm.field.VBox;
import org.deuce.transaction.jvstm.field.VBoxBBody;
import org.deuce.transaction.jvstm.field.VBoxBody;
import org.deuce.transaction.jvstm.field.VBoxCBody;
import org.deuce.transaction.jvstm.field.VBoxDBody;
import org.deuce.transaction.jvstm.field.VBoxFBody;
import org.deuce.transaction.jvstm.field.VBoxIBody;
import org.deuce.transaction.jvstm.field.VBoxLBody;
import org.deuce.transaction.jvstm.field.VBoxOBody;
import org.deuce.transaction.jvstm.field.VBoxSBody;
import org.deuce.transaction.jvstm.field.VBoxZBody;
import org.deuce.transaction.jvstm.field.Value;
import org.deuce.transaction.jvstm.pool.Pool;
import org.deuce.transaction.jvstm.pool.ResourceFactory;
 ...
 * 
 * @author Ricardo Dias
 * @version Jan 27, 2012 15:00:19 PM
 *
 */
@ExcludeInternal
...
//	private static final boolean USE_SPIN_LOCK = Boolean.getBoolean("org.deuce.transaction.jvstm2.spin");
	private static final boolean USE_SPIN_LOCK = false;
	...
	public Object onReadAccess(Object obj, Object value, long field) {
		VBox box = VBoxContainer.getVBoxO(obj, field, value);
	...
	public boolean onReadAccess(Object obj, boolean value, long field) {
		VBox box = VBoxContainer.getVBoxZ(obj, field, value);
	...
	public byte onReadAccess(Object obj, byte value, long field) {
		VBox box = VBoxContainer.getVBoxB(obj, field, value);
	...
	public char onReadAccess(Object obj, char value, long field) {
		VBox box = VBoxContainer.getVBoxC(obj, field, value);
	...
	public short onReadAccess(Object obj, short value, long field) {
		VBox box = VBoxContainer.getVBoxS(obj, field, value);
	...
	public int onReadAccess(Object obj, int value, long field) {
		VBox box = VBoxContainer.getVBoxI(obj, field, value);
	...
	public long onReadAccess(Object obj, long value, long field) {
		VBox box = VBoxContainer.getVBoxL(obj, field, value);
	...
	public float onReadAccess(Object obj, float value, long field) {
		VBox box = VBoxContainer.getVBoxF(obj, field, value);
	...
	public double onReadAccess(Object obj, double value, long field) {
		VBox box = VBoxContainer.getVBoxD(obj, field, value);
	...
	public void onWriteAccess(Object obj, Object value, long field) {
		...
		v.value = value;
		boxesWritten.put(VBoxContainer.getVBoxO(obj, field, value), v);
	}
	...
	public void onWriteAccess(Object obj, boolean value, long field) {
		...
		v.value = value;
		boxesWritten.put(VBoxContainer.getVBoxZ(obj, field, value), v);
	}
	...
	public void onWriteAccess(Object obj, byte value, long field) {
		...
		v.value = value;
		boxesWritten.put(VBoxContainer.getVBoxB(obj, field, value), v);
	}
	...
	public void onWriteAccess(Object obj, char value, long field) {
		...
		v.value = value;
		boxesWritten.put(VBoxContainer.getVBoxC(obj, field, value), v);
	}
	...
	public void onWriteAccess(Object obj, short value, long field) {
		...
		v.value = value;
		boxesWritten.put(VBoxContainer.getVBoxS(obj, field, value), v);
	}
	...
	public void onWriteAccess(Object obj, int value, long field) {
		...
		v.value = value;
		boxesWritten.put(VBoxContainer.getVBoxI(obj, field, value), v);
	}
	...
	public void onWriteAccess(Object obj, long value, long field) {
		...
		v.value = value;
		boxesWritten.put(VBoxContainer.getVBoxL(obj, field, value), v);
	}
	...
	public void onWriteAccess(Object obj, float value, long field) {
		...
		v.value = value;
		boxesWritten.put(VBoxContainer.getVBoxF(obj, field, value), v);
	}
	...
	public void onWriteAccess(Object obj, double value, long field) {
		...
		v.value = value;
		boxesWritten.put(VBoxContainer.getVBoxD(obj, field, value), v);
	}
