 ...
 */
@ExcludeInternal
public class VBoxFieldZ extends TxBooleanField implements VBoxZ {
	public VersionZ version;

	public VBoxFieldZ(Object ref, long address) {
		super(ref, address);
		version = new VersionZ(0, read(), null);
	}
	...
	public void commit(boolean newValue, int txNumber) {
		VersionZ ver = new VersionZ(txNumber, newValue, version);
		this.version = ver;
	}
	...
	static {
		try {
			__LOCK_FIELD__ = AddressUtil.getAddress(VBoxFieldZ.class.getDeclaredField("lock"));
