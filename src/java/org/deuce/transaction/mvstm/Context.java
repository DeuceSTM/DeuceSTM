...
import org.deuce.transaction.mvstm.field.BooleanWriteFieldAccess;
import org.deuce.transaction.mvstm.field.ByteWriteFieldAccess;
import org.deuce.transaction.mvstm.field.CharWriteFieldAccess;
import org.deuce.transaction.mvstm.field.DoubleWriteFieldAccess;
import org.deuce.transaction.mvstm.field.FloatWriteFieldAccess;
import org.deuce.transaction.mvstm.field.IntWriteFieldAccess;
import org.deuce.transaction.mvstm.field.LongWriteFieldAccess;
import org.deuce.transaction.mvstm.field.ObjectWriteFieldAccess;
import org.deuce.transaction.mvstm.field.ReadFieldAccess;
import org.deuce.transaction.mvstm.field.ShortWriteFieldAccess;
import org.deuce.transaction.mvstm.field.VBox;
import org.deuce.transaction.mvstm.field.VersionB;
import org.deuce.transaction.mvstm.field.VersionC;
import org.deuce.transaction.mvstm.field.VersionD;
import org.deuce.transaction.mvstm.field.VersionF;
import org.deuce.transaction.mvstm.field.VersionI;
import org.deuce.transaction.mvstm.field.VersionL;
import org.deuce.transaction.mvstm.field.VersionO;
import org.deuce.transaction.mvstm.field.VersionS;
import org.deuce.transaction.mvstm.field.VersionZ;
import org.deuce.transaction.mvstm.field.WriteFieldAccess;
import org.deuce.transaction.mvstm.pool.Pool;
import org.deuce.transaction.mvstm.pool.ResourceFactory;
...
public final class Context implements org.deuce.transaction.ContextMetadata {
	...
	static {
		Integer mm = Integer.getInteger("org.deuce.transaction.mvstm.versions");
		if (mm != null) {
			MAX_VERSIONS = mm;
		}
	}
