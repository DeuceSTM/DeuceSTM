 ...
 */
@ExcludeInternal
public class VBoxFieldO extends TxObjectField implements VBoxO {
	...
	public void commit(Object newValue, int txNumber) {
		VersionO ver = new VersionO(txNumber, newValue, version);
		this.version = ver;
	}
	...
	static {
		try {
			__LOCK_FIELD__ = AddressUtil.getAddress(VBoxFieldO.class.getDeclaredField("lock"));
