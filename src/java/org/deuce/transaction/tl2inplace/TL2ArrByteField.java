...
@ExcludeInternal
public class TL2ArrByteField extends TxArrByteField implements InPlaceLock {

	public TL2ArrByteField(byte[] arr, int idx) {
		super(arr, idx);
	}
	...
	static {
		try {
			__LOCK_FIELD__ = AddressUtil.getAddress(TL2ArrByteField.class.getDeclaredField("lock"));
