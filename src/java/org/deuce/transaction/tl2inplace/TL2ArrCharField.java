...
@ExcludeInternal
public class TL2ArrCharField extends TxArrCharField implements InPlaceLock {

	public TL2ArrCharField(char[] arr, int idx) {
		super(arr, idx);
	}
	...
	static {
		try {
			__LOCK_FIELD__ = AddressUtil.getAddress(TL2ArrCharField.class.getDeclaredField("lock"));
