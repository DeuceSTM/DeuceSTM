...
@ExcludeInternal
public class TL2ArrFloatField extends TxArrFloatField implements InPlaceLock {

	public TL2ArrFloatField(float[] arr, int idx) {
		super(arr, idx);
	}
	...
	static {
		try {
			__LOCK_FIELD__ = AddressUtil.getAddress(TL2ArrFloatField.class.getDeclaredField("lock"));
