...
@ExcludeInternal
public class TL2ArrLongField extends TxArrLongField implements InPlaceLock {

	public TL2ArrLongField(long[] arr, int idx) {
		super(arr, idx);
	}
	...
	static {
		try {
			__LOCK_FIELD__ = AddressUtil.getAddress(TL2ArrLongField.class.getDeclaredField("lock"));
