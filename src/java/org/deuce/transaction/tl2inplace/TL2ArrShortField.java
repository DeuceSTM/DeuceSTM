...
@ExcludeInternal
public class TL2ArrShortField extends TxArrShortField implements InPlaceLock {

	public TL2ArrShortField(short[] arr, int idx) {
		super(arr, idx);
	}
	...
	static {
		try {
			__LOCK_FIELD__ = AddressUtil.getAddress(TL2ArrShortField.class.getDeclaredField("lock"));
