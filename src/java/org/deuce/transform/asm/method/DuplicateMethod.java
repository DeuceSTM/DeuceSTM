...
/**
 * Responsible for creating the mirror version for the original method that
...
public class DuplicateMethod extends MethodAdapter {
	...
	public void visitFieldInsn(int opcode, String owner, String name, String desc) {
		...
		case GETSTATIC: // check support for static fields
			super.visitFieldInsn(GETSTATIC, fieldsHolderName, StaticMethodTransformer.CLASS_BASE, "Ljava/lang/Object;");
	...
	public void visitInsn(int opcode) {
		...
		case AALOAD:
			...
			String arrayType = (String) this.analyzerAdapter.stack.get(this.analyzerAdapter.stack.size() - 2);
