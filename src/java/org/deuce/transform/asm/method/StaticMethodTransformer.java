...
public class StaticMethodTransformer extends MethodAdapter {
	...
	private void addField(Field field) {
		...
		staticMethod.visitMethodInsn(INVOKESTATIC, "org/deuce/reflection/AddressUtil", "getAddress",
	...
	private void addClassBase(String staticFieldBase) {
		...
		staticMethod.visitMethodInsn(INVOKESTATIC, "org/deuce/reflection/AddressUtil", "staticFieldBase",
