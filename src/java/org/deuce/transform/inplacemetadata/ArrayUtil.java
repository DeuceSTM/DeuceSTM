...
public class ArrayUtil {
  ...
  public static Type getTxArrayArrayType(String desc) {
    ...
    return Type.getType(
        dim > 1 ? getArrayDimDesc(1) + Type.getType(
                    ContextDelegator.getArrayObjectClass()) 
  ...
  public static Type getTypeFromTxArray(Type t) {
    ...
    else // object or array type: impossible to know the source type
      return null;
  }
  
  public static Type getTypeFromNewarrayOpcode(int opcode) {
    switch(opcode) {
    case Opcodes.T_BOOLEAN: return Type.BOOLEAN_TYPE;
    case Opcodes.T_CHAR: return Type.CHAR_TYPE;
    case Opcodes.T_FLOAT: return Type.FLOAT_TYPE;
    case Opcodes.T_DOUBLE: return Type.DOUBLE_TYPE;
    case Opcodes.T_BYTE: return Type.BYTE_TYPE;
    case Opcodes.T_SHORT: return Type.SHORT_TYPE;
    case Opcodes.T_INT: return Type.INT_TYPE;
    case Opcodes.T_LONG: return Type.LONG_TYPE;
    default: return null;
    }
  }
