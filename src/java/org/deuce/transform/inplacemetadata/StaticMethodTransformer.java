...
public class StaticMethodTransformer extends MethodAdapter {
  ...
  private void addField(Field field) {
     ...
     * 
     * Concept code:
     *   cAFieldHolder.mA__ADDRESS__ = new TxField(inst, AddressUtil.getAddress(java.lang.Class<cA>.getDeclaredField("mA")));
     */
    // stack: ... =>
    ...
    super.visitLdcInsn(field.getFieldName());
    // stack: ..., TxField, TxField, Object, Class (owner), String (this field) =>
