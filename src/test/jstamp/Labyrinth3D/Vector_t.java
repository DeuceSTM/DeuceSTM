...
public class Vector_t {
	...
	/*
	 * ==========================================================================
	 * === Vector_alloc -- Returns null if failed
	 * ================================
	 * =============================================
	 */
	...
	/*
	 * ==========================================================================
	 * === Vector_at -- Returns null if failed
	 * ==================================
	 * ===========================================
	 */
	...
	/*
	 * ==========================================================================
	 * === Vector_pushBack -- Returns false if fail, else true
	 * ==================
	 * ===========================================================
	 */
	...
	/*
	 * ==========================================================================
	 * === Vector_popBack -- Returns null if fail, else returns last element
	 * ====
	 * =========================================================================
	 */
	 ...
	 * ===================
	 * 
	 * public void vector_sort () { //qsort.sort(elements, 0, (elements.length -
	 * 1)); qsort.sort(elements); //qsort(elements, size, 4, compare); }
	 * 
	 * ==========================================================================
	 * === Vector_copy
	 * ==========================================================
