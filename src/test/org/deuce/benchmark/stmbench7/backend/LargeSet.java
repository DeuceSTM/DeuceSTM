...
/**
 * A large set: of the size in the order of at least a few hundreds of elements.
 * Used by a composite part to hold the set of child atomic parts, and by the
 * AtomicPart.buildDate index to hold all atomic parts with the same build date.
 */
@Atomic
