...
import org.deuce.benchmark.stmbench7.operations.BaseOperation;

/**
 * Used to create and destroy atomic parts while maintaining the consistency of
 * the data structure and the indexes.
 */
@Immutable
public class AtomicPartBuilder extends DesignObjBuilder {
	...
	public AtomicPart createAndRegisterAtomicPart() throws OperationFailedException {
		...
		int x = ThreadRandom.nextInt(Parameters.XYRange), y = x + 1; // convenient
																		// for
																		// invariant
																		// tests
