...
/**
 * A factory for creating all the objects of the main benchmark data structure.
 * A default implementation is provided by the
 * stmbench7.impl.core.DesignObjFactoryImpl class, but most STM implementations
 * will provide their own implementation, which will create transaction-safe
 * versions of the data structure elements.
 */
@Immutable
public abstract class DesignObjFactory {
	...
	public abstract BaseAssembly createBaseAssembly(int id, String type, int buildDate, Module module,
			ComplexAssembly superAssembly);

	public abstract ComplexAssembly createComplexAssembly(int id, String type, int buildDate, Module module,
			ComplexAssembly superAssembly);

	public abstract CompositePart createCompositePart(int id, String type, int buildDate, Document documentation);
