...
/**
 * Used to create and destroy document elements while maintaining the
...
public class DocumentBuilder extends DesignObjBuilder {
	...
	public Document createAndRegisterDocument(int compositePartId) throws OperationFailedException {
		...
		String docText = createText(Parameters.DocumentSize, "I am the documentation for composite part #"
				+ compositePartId + "\n");
