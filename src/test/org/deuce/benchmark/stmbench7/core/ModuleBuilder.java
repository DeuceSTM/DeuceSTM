...
/**
 * Used to create a module element with the default initial data structure
 * underneath. Calls other builder classes to construct respective elements of
 * the structure.
 */
@Immutable
public class ModuleBuilder extends DesignObjBuilder {
	...
	public ModuleBuilder(Index<Integer, BaseAssembly> baseAssemblyIdIndex,
		...
		assemblyBuilder = new AssemblyBuilder(baseAssemblyIdIndex, complexAssemblyIdIndex);
