...
import org.deuce.benchmark.stmbench7.impl.backend.SmallSetImpl;

/**
 * STMBench7 benchmark Atomic Part (see the specification). Default
 * implementation.
 */
public class AtomicPartImpl extends DesignObjImpl implements AtomicPart {
	...
	public String toString() {
		return super.toString() + ", x=" + x + ", y=" + y + ", partOf=[" + partOf + "]" + ", to={ " + to.size()
				+ " connections }, from={ " + from.size() + " connections }";
	}
}
