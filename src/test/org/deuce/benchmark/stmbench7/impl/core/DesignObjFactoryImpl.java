 ...
 * stmbench7.core. This default implementation constructs objects that are NOT
 * thread-safe.
 */
public class DesignObjFactoryImpl extends DesignObjFactory {
	...
	@Override
	public Connection createConnection(AtomicPart from, AtomicPart to, String type, int length) {
		return new ConnectionImpl(from, to, type, length);
	}

	@Override
	public BaseAssembly createBaseAssembly(int id, String type, int buildDate, Module module,
			ComplexAssembly superAssembly) {
		return new BaseAssemblyImpl(id, type, buildDate, module, superAssembly);
	}

	@Override
	public ComplexAssembly createComplexAssembly(int id, String type, int buildDate, Module module,
			ComplexAssembly superAssembly) {
		return new ComplexAssemblyImpl(id, type, buildDate, module, superAssembly);
	}

	@Override
	public CompositePart createCompositePart(int id, String type, int buildDate, Document documentation) {
