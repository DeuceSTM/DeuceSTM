...
import org.deuce.benchmark.stmbench7.impl.core.ComplexAssemblyImpl;

/**
 * An implementation of the ComplexAssembly interface used in the medium-grained
 * locking synchronization method. The complex assembly is locked for reading or
 * writing by the methods that read or modify the object (except for cases when
 * the required locking is done externally).
 */
public class MGLockingComplexAssemblyImpl extends ComplexAssemblyImpl {

	public MGLockingComplexAssemblyImpl(int id, String type, int buildDate, Module module, ComplexAssembly superAssembly) {
