...
/**
 * Query Q2 / Operation OP2 (see the specification). Read-only, range query on
 * index.
 */
public class Query2 extends BaseOperation {
	...
	protected Query2(Setup oo7setup, int percent) {
		...
		this.minAtomicDate = Parameters.MaxAtomicDate - percent * (Parameters.MaxAtomicDate - Parameters.MinAtomicDate)
				/ 100;
	}
